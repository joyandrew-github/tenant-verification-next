        ...
        <div className="bg-gradient-to-br from-slate-800/60 to-slate-700/40 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-slate-600/30 w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 text-sm">
              Join our secure tenant verification platform
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-300">
              ...
              <Link href="/auth/signin" className="text-cyan-400 hover:text-cyan-300 transition-colors duration-300 font-medium">
                Sign In
              </Link>
            </p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-600/50 text-center">
            <p className="text-gray-300 mb-4 text-sm">Or sign up with</p>
            <button
